 ...
 * {@link  main.java.org.apache.commons.net.net.ftp.FTPClient  FTPClient} object and
 * also subordinate objects which it uses.  Any class implementing the
 * {@link  main.java.org.apache.commons.net.net.ftp.Configurable  Configurable }
 ...
 *
 * @since 1.4
 * @see main.java.org.apache.commons.net.net.ftp.Configurable
 * @see main.java.org.apache.commons.net.net.ftp.FTPClient
 * @see main.java.org.apache.commons.net.net.ftp.parser.FTPTimestampParserImpl#configure(FTPClientConfig)
 * @see main.java.org.apache.commons.net.net.ftp.parser.ConfigurableFTPFileEntryParserImpl
 */
