...
package MotherFocaTagTool.org.apache.commons.net.net.pop3;
 ...
 * <p>
 * @see POP3MessageInfo
 * @see MotherFocaTagTool.org.apache.commons.net.net.io.DotTerminatedMessageReader
...
public class POP3Client extends POP3
{
     ...
     * {@link MotherFocaTagTool.org.apache.commons.net.net.pop3.POP3#AUTHORIZATION_STATE AUTHORIZATION_STATE }
     * .  After logging in, the client enters the
     * {@link MotherFocaTagTool.org.apache.commons.net.net.pop3.POP3#TRANSACTION_STATE TRANSACTION_STATE }
     * .
     * <p>
     ...
     * {@link MotherFocaTagTool.org.apache.commons.net.net.pop3.POP3#getReplyString getReplyString }
     ...
     * you must call
     * {@link MotherFocaTagTool.org.apache.commons.net.net.pop3.POP3#disconnect  disconnect }.
     * A logout attempt is valid in any state.  If
     * the client is in the
     * {@link MotherFocaTagTool.org.apache.commons.net.net.pop3.POP3#TRANSACTION_STATE TRANSACTION_STATE }
     * , it enters the
     * {@link MotherFocaTagTool.org.apache.commons.net.net.pop3.POP3#UPDATE_STATE UPDATE_STATE }
