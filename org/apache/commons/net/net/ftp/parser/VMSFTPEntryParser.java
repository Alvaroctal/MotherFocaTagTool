...
import MotherFocaTagTool.org.apache.commons.net.net.ftp.FTPFile;
 ...
 *
 * @see MotherFocaTagTool.org.apache.commons.net.net.ftp.FTPFileEntryParser FTPFileEntryParser (for usage instructions)
...
//    @Override
    ...
    public FTPFile[] parseFileList(java.io.InputStream listStream) throws IOException {
        MotherFocaTagTool.org.apache.commons.net.net.ftp.FTPListParseEngine engine = new MotherFocaTagTool.org.apache.commons.net.net.ftp.FTPListParseEngine(this);
